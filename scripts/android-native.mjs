...
// Keep the native window out of fullscreen mode. Android 15 draws apps edge-to-edge
// by default, so the WebView itself is also given the live system-bar insets below.
